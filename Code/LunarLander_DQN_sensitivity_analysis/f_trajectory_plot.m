...
if settings.resultType == "training"
    if settings.plotBadTrajectory == true
        filename = "/SimOut_Media/training_badTrajectory_" + settings.plot_filename;
    else
        filename = "/SimOut_Media/training_goodTrajectory_" + settings.plot_filename;
    end
elseif settings.resultType == "simulation"
    if settings.plotBadTrajectory == true
        filename = "/SimOut_Media/sim_badTrajectory_" + settings.plot_filename;
    else
        filename = "/SimOut_Media/sim_goodTrajectory_" + settings.plot_filename;
    end
end
